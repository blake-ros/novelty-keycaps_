  ...
  render(props) {
    ...
    return (
      <div className="container-fluid">
        ...
        {itemsInCart}
        {cartArray.map(item => { return <CartSummaryItem getCartItems={this.props.getCartItems} key={item.cartItemId} cartItem={item} removeItem={this.props.removeItem} cart={this.props.cart} />; })}
        <h4 className="text-secondary mb-3">Total: ${cartTotal} {button}</h4>
      </div>
    );
  }
}
