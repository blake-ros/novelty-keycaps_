...
class ProductList extends React.Component {
  ...
  render() {
    const myProducts = this.state.products.map(product => {
      ...
      return <ProductListItem key={product.productId} image={product.image} name={product.name} price={newerNumber} shortDescription={product.shortDescription} onClick={this.props.onClick}/>;
    });
